...
data <- data %>%
  mutate(cat_g3 = case_when(
    G3 == 0 ~ "0-3",
    G3 == 4 | G3 == 5 | G3 == 6 | G3 == 7 ~ "4-7",
    G3 == 8 | G3 == 9 | G3 == 10 | G3 == 11 ~ "8-11",
    G3 == 12 | G3 == 13 | G3 == 14 | G3 == 15 ~ "12-15",
    G3 == 16 | G3 == 17 | G3 == 18 | G3 == 19 | G3 == 20 ~"16-20"
  ))


data <- data %>%
  mutate(cat_g3 = factor(cat_g3, levels=c("0-3", "4-7", "8-11", "12-15", "16-20"), ordered=TRUE))
...
```
Still not very accurate for the training with 
...
Predictors chosen from EDA and previous exploration: 
